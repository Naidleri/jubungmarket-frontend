...
export const ProductProvider = ({ children }: ProductProviderProps) => {
    ...
    const getAllProducts = async () => {
      ...
      try {
        ...
        setError(err instanceof Error ? err.message : 'Gagal to fetch products');
      } finally {
        setLoading(false);
      }
    };
    ...
    const getProductById = async (id: number) => {
      ...
      try {
        ...
        setError(err instanceof Error ? err.message : 'Gagal fetch product');
      } finally {
        setLoading(false);
      }
    };
    ...
    const addProduct = async (newProduct: FormData) => {
      ...
      try {
        ...
        setError(err instanceof Error ? err.message : 'Gagal add product');
      } finally {
        setLoading(false);
      }
    };
    ...
    const updateProduct = async (id: number, updatedProduct: FormData) => {
      ...
      try {
        ...
        setError(err instanceof Error ? err.message : 'Gagal update product');
      } finally {
        setLoading(false);
      }
    };
    ...
    const deleteProduct = async (id: number) => {
      ...
      try {
        ...
        setError(err instanceof Error ? err.message : 'Gagal delete product');
      } finally {
        setLoading(false);
      }
    };
